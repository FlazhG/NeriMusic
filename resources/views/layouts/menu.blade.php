...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="css/css-menu/adminlte.min.css">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.html" class="brand-link">
      <img src="img/Flazh.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Admin Flazh</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="img/OIP.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Barry Allen</a>
        </div>
      </div>
      <!-- SidebarSearch Form -->
  ...
  <!-- AdminLTE App -->
  <script src="js/js-menu/adminlte.js"></script>
