...
<main>
    ...
    <form action="{{url('/user')}}" method="post" enctype="multipart/form-data" class="formulario" id="formulario">
        ...
        <div class="formulario__grupo" id="grupo__date_usu">
            ...
            <p class="formulario__input-error">La fecha de nacimiento es requerida</p>
        ...
        <div class="formulario__grupo formulario__grupo-btn-enviar">
            <button type="submit" id="guardar" disabled class="formulario__btn">Enviar</button>
        </div>
...
@section('js')
<script src="{{asset ('js/users/users-campos.js')}}"></script>
